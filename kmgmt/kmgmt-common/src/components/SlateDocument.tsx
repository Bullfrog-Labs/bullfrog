...
export function SlateDocument(props: {
  ...
  const logger = log.getLogger("SlateDocument");
  ...
  if (TypedElement.isTypedElement(node)) {
    ...
    // NOTE: This will handle cases where the type field was generated by a
    // newer version of the code, and is not recognized by this version (for
    // example if a newer version was deployed and allowed to generate new
    // element types).
